...
test("MessageList shows content and loading for last assistant message with text parts", () => {
  const messages: UIMessage[] = [
    {
      id: "1",
      role: "assistant",
  ...
  // The component shows both the content and the loading indicator while streaming
